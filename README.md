...
> **Status: In development** — data models, budget accumulator, trace writer, Docker sandbox, agent base class, Generator agent (with live console output and prompt caching), patch extraction, SQLite persistence, orchestrator, CLI, and Reproducer agent implemented; Evaluator agent, two-agent orchestrator wiring, eval dataset, and MCP server pending
